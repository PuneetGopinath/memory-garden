    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 gap-16 px-8 py-16 lg:py-0 max-w-7xl mx-auto w-full items-center pt-20">
            <div className="flex flex-col space-y-8 max-w-2xl">
                <h1 className="text-5xl lg:text-7xl font-bold mb-4 leading-tight tracking-tight">Make your memories active not dormant.</h1>
                <p className="text-zinc-400 text-lg mb-6 max-w-xl">We make sure your memories floats in your mind, not in a folder.</p>
